...
class RequestUtil
{
     ...
     * lost.
     * This function examines the original request URI and updates $_REQUEST
     ...
     *
     * @param bool $include_querystring
     *          (optional) Specify true/false to include querystring. Default is true.
     * @param bool $append_post_vars
     ...
     *          name of the html form field
     * @param bool $b64encode
     *          true to base64encode file data (default false)
     * @param bool $ignore_empty
     *          true to not throw exception if form fields doesn't contain a file (default false)
     * @param int $max_kb
     *          maximum size allowed for upload (default unlimited)
     * @param array $ok_types
     *          if array is provided, only files with those Extensions will be allowed (default all)
     ...
     *          name of the html form field
     * @param bool $b64encode
     *          true to base64encode file data (default true)
     * @param bool $ignore_empty
     *          true to not throw exception if form fields doesn't contain a file (default false)
     * @param int $max_kb
     *          maximum size allowed for upload (default unlimited)
     ...
     *          value returned if $_REQUEST[$fieldname] is blank or null (default = empty string)
     * @param bool $escape
     *          if true htmlspecialchars($val) is returned (default = false)
     * @param bool $ignorecase
     *          if true then request fieldname will not be case sensitive (default = false)
     * @return string | array
     */
     ...
     * if default value is not provided,
